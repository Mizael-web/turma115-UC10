const Livro = require('../src/Models/livroModel'); // ajuste o caminho conforme necessário
...
class LivroController {
  static async criar(req, res) {
    try {
      ...
      return res.status(500).json({ msg: 'Erro interno ao criar livro', error: error.message });
    }
  }
}
